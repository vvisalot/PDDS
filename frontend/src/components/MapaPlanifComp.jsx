...
const MapaPlanifComp = ({ trucks, truckPositions, completedTrucks, simulatedTime, trucksCompletos, camionesEnMapa, totalPedidos, pedidosEntregados }) => {
  ...
  return (
    <div style={{ position: "relative", height: "100%", width: "100%" }}>
      <MapContainer center={[-13.5, -76]} zoom={6} style={{ height: '100%', width: '100%' }}>
        ...
        {/* Renderizar LeyendaPlanif enviando estadísticas como props */}
        <LeyendaPlanif
